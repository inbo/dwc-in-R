...
```{r}
write_tsv(females_weight_above_30, 
          path = "../data/processed/females_weight_above_30.csv")
```
...
```{r}
write_csv(data_scientificname, 
          path = "../data/processed/data_scientificname.csv")
```
